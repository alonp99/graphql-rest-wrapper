...
var _RestWrapper = function () {
    ...
    _createClass(_RestWrapper, [{
        ...
        key: '_wrapSchema',
        value: function _wrapSchema(schema) {
            return (0, _schemaGenerator2.default)(this.endpoint, { saveToFile: this.options.saveSchema, name: this.options.name, wrapMode: true, providedSchema: schema });
        }
    }, {
