...
var createSchema = function () {
    var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(endpoint) {
        ...
        var _getName, saveToFile, name, request, json, schemaString, schema;
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    ...
                    case 8:
                        json = _context.sent;
                        schemaString = (0, _maker2.default)(json);

                        if (saveToFile) {
                            (function () {
                                var filename = name + '.js';
                                _fs2.default.writeFile(filename, schemaString, function (msg) {
                        ...
                        schema = new GraphQLSchema({
                            query: new GraphQLObjectType({
                                ...
                                fields: function fields() {
                                    var obj = {};
                                    obj[name] = {
                                        type: (0, _requireFromString2.default)(schemaString),
